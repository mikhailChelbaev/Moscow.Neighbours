...
//    ),
    "Борис Пастернак" : .init(
        person: Person(
            ...
            shortDescription: """
                Один из самых значительных и известных русских поэтов ХХ века, лауреат Нобелевской премии (1958). Поэзия Пастернака сочетает невероятные метафоры об окружающем мире и детали из собственной биографии.Любимые темы в текстах Пастернака — преображение мира,, судьба поэта и поэзия в окружающем мире.
                """,
            description: """
    ...
    "Фёдор Тютчев": .init(
        person: Person(
            ...
            description: """
                ...
                Место / Усадьба семьи Тютчева
                В этом доме Фёдор Тютчев провел свои детские и юношеские годы, живя вместе со своими родителями до 1822 года. Здесь поэт написал свои первые стихи и сделал переводы римских классиков.
...
//    ),
    Route(
        ...
        description: "Маршрут для быстрого знакомства с деятельностью писателей, инженеров, художников и скульпторов. Короткая прогулка по этим местам откроет с новой стороны уже известные вам здания. Вы узнаете, где Владимир Шухов работал над своими первыми изобретениями и какие виды описывал Борис Пастернак в одном из своих стихотворений. Новые впечатления от привычных мест!",
